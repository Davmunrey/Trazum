...
```
 ...
 49 commands   MCP server    the editor      Next.js    comments on
...
- [The 49 commands](#the-49-commands): the whole surface, one line each
...
above](#the-49-commands) names what each answers — because knowing a prompt
...
[table above](#the-49-commands) links to.
