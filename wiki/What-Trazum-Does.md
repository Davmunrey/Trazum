...
is the smallest thing here. `optimize` is one of 49 commands — [the table
above](https://github.com/Davmunrey/Trazum/blob/main/README.md#the-49-commands) names what each answers — because knowing a prompt
