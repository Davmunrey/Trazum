...
const COPY: Record<MarketingLocale, Copy> = {
  en: {
    ...
    doorCliTitle: 'CLI + CI',
    doorCliBody:
      '49 commands. Token budgets and drift baselines that exit 1, a pre-commit hook that is one pipe, and a GitHub Action that comments the report on your PR.',
  ...
  es: {
    ...
    doorCliTitle: 'CLI + CI',
    doorCliBody:
      '49 comandos. Presupuestos de tokens y baselines de deriva que salen con 1, un hook de pre-commit que es una tubería, y una GitHub Action que comenta el informe en tu PR.',
    doorGatewayTitle: 'Gateway',
    doorGatewayBody:
  ...
  pt: {
    ...
    doorCliTitle: 'CLI + CI',
    doorCliBody:
      '49 comandos. Orçamentos de tokens e baselines de deriva que saem com 1, um hook de pré-commit que é um só pipe, e uma GitHub Action que comenta o relatório no seu PR.',
    doorGatewayTitle: 'Gateway',
    doorGatewayBody:
