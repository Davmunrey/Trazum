...
export const es: WebMessages = {
  ...
  page: {
    ...
    footerLead: (pricingReviewed) =>
      `Precios revisados el ${pricingReviewed}. El recuento de tokens es una estimación (±25%); para cifras exactas usa el endpoint oficial de recuento desde la CLI con `,
