  ...
  tour: {
    ...
    steps: {
      ...
      cli: {
        ...
        body:
          '"trazum position usage.jsonl" closes the loop in one line: the month against its configured ceiling, measured, verdict attached. Everything you just watched is the real CLI: 47 commands install with "npm i -g @trazum/cli", and "help" lists what the browser can run.',
      },
      finish: {
