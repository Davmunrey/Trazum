...
| [1.52–1.60](plan-1.52-1.60.md) | Nine arcs: finish what shipped incomplete, then widen | **in progress** — 1.52.0, 1.53.0, 1.55.0 and 1.56.0 landed; 1.57, 1.59 and 1.60 each have chapters; 1.54.0 blocked on provider keys |
